...
void MCU_init(void)
{
  ...
  ICSC1 = 4;                           /* Initialization of the ICS control register 1 */
  ...
  ICSSC = (ICSSC & (unsigned char)~192) | (unsigned char)32; /* Initialization of the ICS status and control */
